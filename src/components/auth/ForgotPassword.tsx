    ...
    <div style={{ padding: 32, display: 'flex', justifyContent: 'center' }}>
      <div style={{ width: '100%', maxWidth: 480 }}>
        <div style={{ marginBottom: 16, textAlign: 'center' }}>
          ...
          <p style={{ marginTop: 8, color: '#64748b' }}>Gib deine E-Mail-Adresse ein und wir senden dir einen Link zum Zurücksetzen.</p>
        </div>
        ...
        {sent ? (
          <div style={{ background: 'white', padding: 24, borderRadius: 10, boxShadow: '0 8px 24px rgba(15,23,42,0.06)', textAlign: 'center' }}>
            ...
            <p style={{ color: '#64748b' }}>Falls ein Konto mit dieser Adresse existiert, erhältst du in Kürze eine E-Mail mit einem Link zum Zurücksetzen deines Passworts.</p>
            <button onClick={() => nav('/login')} style={{ marginTop: 16, padding: '10px 16px', background: '#2b6cb0', color: 'white', border: 'none', borderRadius: 8, cursor: 'pointer' }}>Zurück zum Login</button>
          </div>
        ) : (
